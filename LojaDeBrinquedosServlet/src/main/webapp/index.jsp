...
<title>Inicio - Loja de Brinquedos</title>
</head>
<body>
	...
	<div class="viewport">
		...
		<div class="sidebar">
			...
			<ul class="nav">
				...
				<li>
					<a href="catalogo.jsp"><span>Catálogo de Brinquedo</span></a>
				</li>
				<li>
		...
		<div class="content">
			<div class="container-fluid">
				<div id="title">
					<nav aria-label="breadcrumb">
					  <ol class="breadcrumb">
					    <li class="breadcrumb-item active" aria-current="page">Brinquedos em Destaque</li>
					  </ol>
					</nav>
				</div>
			</div>
			<div class="container-cards">
				...
				List<Brinquedo> lista = dao.DestaqueBrinquedos();
				if (lista != null) {
				...
				<div class="card" style="width: 18rem;">
					<a id="produto" href="ServletBrinquedo?cmd=mostrar&txtCodigo=<%=a.getId()%>">
						<span><img class="card-img-top" src="<%=a.getUrl_foto()%>" width="80px" height="80px" alt="Card image cap"/>
							<div class="card-body" id="card-produto">
