      ...
      <div class="viewport">
        ...
        <div class="content" id="form-login">
         ...
         <div class="container-large"> 
			<form class="form-product" action="ServletCategoria?cmd=atualizar" method="post" enctype="multipart/form-data">
				<div class="imgEdit">
	              <img src="<%=categoria.getUrl_foto()%>" width="120px" height="120px">
	            </div>
	            <div class="form-group row">
	              <label for="txtCodigo" class="col-sm-2 col-form-label">Código:</label>
	              <div class="col-sm-4">
	                <input type="number" class="form-control" name="txtCodigo" value="<%=categoria.getId()%>" readonly="readonly">
	              </div>
	            </div>
	
	            <div class="form-group row">
	              <label for="txtDescricao" class="col-sm-2 col-form-label">Nome:</label>
	              <div class="col-sm-auto">
	                <input type="text" class="form-control" name="txtNome" value="<%=categoria.getNome()%>" required/>
	              </div>
	            </div>
