  ...
  <body>
    <nav class="navbar navbar-light">
      ...
      <div class="viewport">
		    ...
		    <div class="modal-dialog" role="document">
		        <div class="modal-content">
		            <div class="modal-header">
		                <h5 class="modal-title" id="confirmacaoExclusaoModalLabel">Exclusão de Usuários</h5>
		                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
		                    <span aria-hidden="true">&times;</span>
		                </button>
		            </div>
		            <div class="modal-body">
		                Confirmar a exclusão do usuário escolhido?
		            </div>
        ...
        <a href="ServletUser?cmd=novo"><button class="btn" id="btn-novo-brinquedo">Novo Usuário</button></a>
            ...
            <tbody>
              <tr>
					...
					if (lista != null) {
					    for (User a : lista) {
					%>
					<tr id="userID<%=a.getId()%>">
					    <td><%=a.getId()%></td>
					    <td><%=a.getLogin()%></td>
					    <td><button class="btn" id="btn-editar" onclick="btnEditarUsuario(this)">Editar</button><button class="btn" id="btn-excluir" onclick="btnExcluirUsuario(this)">Excluir</button></td>
					</tr>
					<%
					    }
					} else {
					    // Lide com a lista de brinquedos nula de acordo com a lógica do seu aplicativo.
						System.out.println("A lista de usuarios enviada para o JSP está nula.");
					}
					%>
            </tbody>
          </table>
