...
<html lang="pt-br">
  <head>
    ...
    <title>Admin - Editar Brinquedo</title>
  </head>
  <body>
      ...
      <div class="viewport">
        ...
        <div class="content" id="form-login">
					...
					<div class="container-breadcrumb">
						<nav aria-label="breadcrumb">
						  <ol class="breadcrumb breadcrumb2">
						    ...
						    <li class="breadcrumb-item active" aria-current="page">Editar Brinquedo</li>
						  </ol>
						</nav>
					</div>
          ...
          <div class="container-large">
	          <form class="form-product" action="ServletBrinquedo?cmd=atualizar" method="post" enctype="multipart/form-data">
	            <div class="imgEdit">
	              <img src="<%=brinquedo.getUrl_foto()%>" width="120px" height="120px">
	            </div>
	            ...
	            <div class="form-group row">
	              ...
	              <div class="col-sm-4">
	                <input type="number" class="form-control" name="txtCodigo" value="<%=brinquedo.getId()%>" readonly="readonly" >
	              </div>
	            </div>
	            ...
	            <div class="form-group row">
	              ...
	              <div class="col-sm-auto">
	                <input type="text" class="form-control" name="txtDescricao" value="<%=brinquedo.getDescricao()%>" required/>
	              </div>
	            </div>
	            ...
	            <div class="form-group row">
	                ...
	                <div class="col-sm-auto">
	                <select class="custom-select" id="selectCategorias"  name="txtCategoria" required>
	                <option value="<%=brinquedo.getId_categoria()%>" selected><%=brinquedo.getNome_categoria()%></option>  
	                <%
	            ...
	            <div class="form-group row">
	                ...
	                <div class="col-sm-auto">
	                  <input type="text" class="form-control" name="txtMarca" value="<%=brinquedo.getMarca()%>" required />
	                </div>
	            </div>
	            ...
	            <div class="form-group row">
	                ...
	                <div class="col-sm-4">
	                  <input type="number" step="0.01" class="form-control" name="txtValor" value="<%=brinquedo.getValor()%>" required />
	                </div>
	            </div>
	            ...
	            <div class="form-group row">
	                ...
	                <div class="col-sm-auto">
	               	  <input type="file" class="form-control" id="file" name="file" accept="image/*" onchange="validateFileType()"/>
	            ...
	            <div class="form-group row">
	                ...
	                <div class="col-md">
	                  <textarea class="form-control" name="txtDetalhes" rows="3" required><%=brinquedo.getDetalhes()%></textarea>
	                </div>
	            </div>
